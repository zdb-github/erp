	...
	<form action="<%=basePath%>resource/add.do" method="post">
		<table border="0" class="table0">
			<tr>
				...
				<td width="50%">
					<input type="text" name="resource_name" id="resource_name1" class="dfinput" />
				</td>
			</tr>
			<tr>
				<td class="ftTd">资源路径</td>
				<td>
					<input type="text" name="do_path" id="do_path1" class="dfinput" />
				</td>
			</tr>	
			<tr>
				<td class="ftTd">对应角色</td>
				<td>
					<input type="text" name="role_type" id="role_type1" class="dfinput" />
				</td>
			</tr>	
			<tr>
