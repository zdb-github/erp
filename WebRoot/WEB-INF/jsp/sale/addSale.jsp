	...
	$('#addGoods').click(function () {
                ...
                $( "#alert-win" ).dialog({
				   close: function(event, ui) {
				    ...
				    window.location.href="sale/toAddSale.do?sale_id=${sale_id}";
				   }
				});
     });
...
function selectAll() {
	...
	<% int count = 1; %>
		...
		<div id="po">
		<form action="sale/addSale.do" method="post" id="myForm1"> 
				...
				<tbody>
					...
					<tr>
						<td colspan="6" align="right">
							<input class="btn btn-inverse" id="addGoods" type="button" value="添加销售单商品" />
	...
	<div id="alert-win" title="添加销售单商品" style="display: none;">
        <iframe style="border: 0; width: 100%; height: 100%;" src="sale/toAddSaleGoods.do?sale_id=${sale_id}"></iframe>
    </div>
