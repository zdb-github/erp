...
function addInvoices() {
	window.location.href = "<%=basePath%>purchase/toAddPurchase.do";
}
...
function selectAll() {
	...
	<body>
		...
		<div class="place">
			...
			<ul class="placeul">
				...
				<li>
					<a href="<%=basePath%>purchase/toListPurchase.do">采购管理</a>
				</li>
				<li>
					<a href="#">采购单列表</a>
				</li>
			...
			<!-- 查询采购订单 -->
			<div>
				<form action="<%=basePath%>purchase/toListPurchase.do" method="post">
					<table class="table table-striped table-bordered table-condensed">
						...
						<tbody>
							<tr>
								...
								<td>
									<input id="purchase_id1" name="purchase_id"
	...
	<!-- 工具栏 -->
				...
				<form id="deleteAllInvoices"
					action="<%=basePath%>purchase/deletePurchase.do" method="post">
					<input type="hidden" id="deleteMy" name="purchase_id" />
				</form>
				<form id="updateInvoices"
					action="<%=basePath%>purchase/toUpdatePurchase.do" method="post">
					<input type="hidden" id="updateMy" name="purchase_id" />
				</form>
				<form id="changeStateForm"
					action="<%=basePath%>purchase/updatePurchase.do" method="post">
					<input type="hidden" id="changeMy2" name="purchase_id" />
					<input type="hidden" name="invoices_state" value="B"/>
				</form>
				<form id="changeStateForm2"
					action="<%=basePath%>purchase/updatePurchase.do" method="post">
					<input type="hidden" id="changeMy3" name="purchase_id" />
							...
							<tr>
								...
								<td>
									<form id="myFormLook<%=count%>"
										action="<%=basePath%>purchase/toLookPurchase.do" method="post">
									...
									<form id="myFormUpdate<%=count%>"
										action="<%=basePath%>purchase/toUpdatePurchase.do"
										method="post">
										<input type="hidden" name="purchase_id" value="${p.purchase_id}" />
									</form>
