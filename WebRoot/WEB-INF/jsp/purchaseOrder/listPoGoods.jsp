	...
	<body>
		...
		<div class="place">
			...
			<ul class="placeul">
				...
				<li>
					<a href="<%=basePath%>purchaseOrder/toListPoGoods.do">采购订单商品列表</a>
				</li>
			</ul>
		</div>
		<div class="rightinfo">
			<div class="tools">
				...
				<form id="myFormAdd" action="<%=basePath%>purchaseOrder/toAddPoGoods.do"
					method="post">
					<input type="hidden" name="po_id" value="${po_id}" />
				</form>
									
				<form id="myFormList" action="<%=basePath%>purchaseOrder/toListPoGoods.do"
					method="post">
					<input type="hidden" name="po_id" value="${po_id}" />
				</form>
				
				
				<form id="deleteAllGoods" action="<%=basePath%>purchaseOrder/deletePoGoods.do"
					method="post">
					<input type="hidden" id="deleteAllGoods" name="id" />
				</form>
				<form id="updateGoods" action="<%=basePath%>purchaseOrder/toUpdatePoGoods.do"
					method="post">
						...
						<tr>
							...
							<td>
								...
								<td>
									...
									<form id="myFormLook<%=count%>" action="<%=basePath%>purchaseOrder/toLookPoGoods.do"
										method="post">
										<input type="hidden" name="po_id" value="${gv.po_id}" />
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormDelete<%=count%>" action="<%=basePath%>purchaseOrder/deletePoGoods.do"
										method="post">
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormUpdate<%=count%>" action="<%=basePath%>purchaseOrder/toUpdatePoGoods.do" method="post">
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
