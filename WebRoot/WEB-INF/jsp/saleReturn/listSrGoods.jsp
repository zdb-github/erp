	...
	<body>
		...
		<div class="place">
			...
			<ul class="placeul">
				...
				<li>
					<a href="<%=basePath%>saleReturn/toListSrGoods.do">销售订单商品列表</a>
				</li>
		...
		<div class="rightinfo">
			<div class="tools">
				...
				<form id="myFormAdd" action="<%=basePath%>saleReturn/toAddSrGoods.do"
					method="post">
					<input type="hidden" name="sr_id" value="${sr_id}" />
				</form>
									
				<form id="myFormList" action="<%=basePath%>saleReturn/toListSrGoods.do"
					method="post">
					<input type="hidden" name="sr_id" value="${sr_id}" />
				</form>
				
				
				<form id="deleteAllGoods" action="<%=basePath%>saleReturn/deleteSrGoods.do"
					method="post">
					<input type="hidden" id="deleteAllGoods" name="id" />
				</form>
				<form id="updateGoods" action="<%=basePath%>saleReturn/toUpdateSrGoods.do"
					method="post">
						...
						<tr>
							...
							<td>
								...
								<td>
									...
									<form id="myFormLook<%=count%>" action="<%=basePath%>saleReturn/toLookSrGoods.do"
										method="post">
										<input type="hidden" name="sr_id" value="${gv.sr_id}" />
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormDelete<%=count%>" action="<%=basePath%>saleReturn/deleteSrGoods.do"
										method="post">
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormUpdate<%=count%>" action="<%=basePath%>saleReturn/toUpdateSrGoods.do" method="post">
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
