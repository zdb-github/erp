	...
	<body>
		...
		<div class="place">
			...
			<ul class="placeul">
				...
				<li>
					<a href="<%=basePath%>purchase/toListPurchaseGoods.do">采购管理</a>
				</li>
				<li>
					<a href="#">采购单商品列表</a>
				</li>
		...
		<div class="rightinfo">
			<div class="tools">
				...
				<form id="myFormAdd" action="<%=basePath%>purchase/toAddPurchaseGoods.do"
					method="post">
					<input type="hidden" name="purchase_id" value="${purchase_id}" />
				</form>
									
				<form id="myFormList" action="<%=basePath%>purchase/toListPurchaseGoods.do"
					method="post">
					<input type="hidden" name="purchase_id" value="${purchase_id}" />
				</form>
				
				
				<form id="deleteAllGoods" action="<%=basePath%>purchase/deletePurchaseGoods.do"
					method="post">
					<input type="hidden" id="deleteAllGoods" name="id" />
				</form>
				<form id="updateGoods" action="<%=basePath%>purchase/toUpdatePurchaseGoods.do"
					method="post">
						...
						<tr>
							...
							<td>
								...
								<td>
									...
									<form id="myFormLook<%=count%>" action="<%=basePath%>purchase/toLookPurchaseGoods.do"
										method="post">
										<input type="hidden" name="purchase" value="${gv.purchase_id}" />
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormDelete<%=count%>" action="<%=basePath%>purchase/deletePurchaseGoods.do"
										method="post">
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
									<form id="myFormUpdate<%=count%>" action="<%=basePath%>purchase/toUpdatePurchaseGoods.do" method="post">
										<input type="hidden" name="updateNum" value="${updateNum}"/>
										<input type="hidden" name="id" value="${gv.id}" />
									</form>
