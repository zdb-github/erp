...
<html>
  <head>
    ...
    <title>添加采购订单的商品</title>
		...
		<script type="text/javascript" src="<%=basePath%>js/dropdown.js"></script>
...
<script type="text/javascript">
  ...
  <body>
		<div id="poGoods">
		<form action="purchaseOrder/addPoGoods.do" method="post" id="myForm1"> 
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input id="po_id1" name="po_id" style="width:220px; height:30px"  type="text" value="${po_id}" readonly="readonly"/>
						</td>
						<td></td>
					</tr>
					<tr>
